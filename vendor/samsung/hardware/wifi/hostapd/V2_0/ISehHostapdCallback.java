...
public interface ISehHostapdCallback extends IHostapdCallback {
    ...
    static default ISehHostapdCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default ISehHostapdCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default ISehHostapdCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default ISehHostapdCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default ISehHostapdCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default ISehHostapdCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements ISehHostapdCallback {
        ...
        @Override // android.hardware.wifi.hostapd.V1_1.IHostapdCallback, vendor.samsung.hardware.wifi.hostapd.V2_0.ISehHostapdCallback, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements ISehHostapdCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehHostapdCallback.kInterfaceName, IHostapdCallback.kInterfaceName, IBase.kInterfaceName));
        }
