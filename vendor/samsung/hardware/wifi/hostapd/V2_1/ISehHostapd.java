...
public interface ISehHostapd extends vendor.samsung.hardware.wifi.hostapd.V2_0.ISehHostapd {
    ...
    public static final class SehParams {
        ...
        public final int hashCode() {
            return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(this.v2_0)), Integer.valueOf(HidlSupport.deepHashCode(this.guestPskPassphrase)), Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.enable11ax))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.encryptionType))));
        }
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            this.v2_0.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
            this.guestPskPassphrase = _hidl_blob.getString(_hidl_offset + 32);
            parcel.readEmbeddedBuffer((long) (this.guestPskPassphrase.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 32 + 0, false);
            this.enable11ax = _hidl_blob.getBool(_hidl_offset + 48);
            this.encryptionType = _hidl_blob.getInt32(_hidl_offset + 52);
        }
    ...
    public static final class Proxy implements ISehHostapd {
        ...
        @Override // android.hardware.wifi.hostapd.V1_1.IHostapd, android.hardware.wifi.hostapd.V1_0.IHostapd, vendor.samsung.hardware.wifi.hostapd.V2_1.ISehHostapd, vendor.samsung.hardware.wifi.hostapd.V2_0.ISehHostapd, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.samsung.hardware.wifi.hostapd.V2_1.ISehHostapd
    ...
    public static abstract class Stub extends HwBinder implements ISehHostapd {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehHostapd.kInterfaceName, vendor.samsung.hardware.wifi.hostapd.V2_0.ISehHostapd.kInterfaceName, android.hardware.wifi.hostapd.V1_1.IHostapd.kInterfaceName, android.hardware.wifi.hostapd.V1_0.IHostapd.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{111, -63, 92, 51, 46, 99, -69, -13, -80, 119, 4, 116, -17, -61, -4, -105, 21, 80, -110, -117, 9, 70, 23, -77, -64, -124, 2, -97, 110, 21, -111, 0}, new byte[]{-56, 68, 1, -21, -56, 94, -30, 93, 120, 82, -41, 120, 72, -115, -9, 108, -39, 2, -8, 53, -2, 90, -22, 25, -63, -6, 90, -93, -76, 44, 55, -123}, new byte[]{47, -82, 97, -23, 98, -10, Byte.MIN_VALUE, -111, 51, 95, Byte.MAX_VALUE, -12, 88, 31, -49, -30, -30, -116, -25, -10, 19, 45, 122, 113, 47, -95, 61, 121, 101, 84, 62, 77}, new byte[]{-18, 8, SemWifiApSmartUtil.BLE_BATT_5, 13, -30, 28, -76, 30, 62, -62, 109, 110, -42, 54, -57, 1, -73, -9, 5, 22, -25, 31, -78, 47, 79, -26, 10, 19, -26, 3, -12, 6}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
