...
public interface ISehSupplicantP2pIfaceCallback extends IBase {
    ...
    static default ISehSupplicantP2pIfaceCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default ISehSupplicantP2pIfaceCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default ISehSupplicantP2pIfaceCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default ISehSupplicantP2pIfaceCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default ISehSupplicantP2pIfaceCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default ISehSupplicantP2pIfaceCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements ISehSupplicantP2pIfaceCallback {
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIfaceCallback
    ...
    public static abstract class Stub extends HwBinder implements ISehSupplicantP2pIfaceCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehSupplicantP2pIfaceCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{65, 11, -29, 72, 63, 112, 20, -109, Byte.MAX_VALUE, 91, -41, 67, -28, 79, 104, 1, 58, -57, Byte.MIN_VALUE, -77, -112, 21, -45, 116, 70, 31, 119, -88, 46, -26, 120, 61}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    _hidl_request.enforceInterface(ISehSupplicantP2pIfaceCallback.kInterfaceName);
