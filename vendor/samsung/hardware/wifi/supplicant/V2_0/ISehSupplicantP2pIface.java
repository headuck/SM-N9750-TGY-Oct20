...
public interface ISehSupplicantP2pIface extends ISehSupplicantIface {
    ...
    @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantIface, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    static default ISehSupplicantP2pIface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default ISehSupplicantP2pIface castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default ISehSupplicantP2pIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default ISehSupplicantP2pIface getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default ISehSupplicantP2pIface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default ISehSupplicantP2pIface getService() throws RemoteException {
    ...
    public static final class Proxy implements ISehSupplicantP2pIface {
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIface, vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantIface, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantIface
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIface
    ...
    public static abstract class Stub extends HwBinder implements ISehSupplicantP2pIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehSupplicantP2pIface.kInterfaceName, ISehSupplicantIface.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{77, 63, -90, 93, -45, -62, SemWifiApSmartUtil.BLE_BATT_5, 104, -91, 118, -46, 122, 11, 99, 122, 63, 87, 51, 22, 73, -61, -36, 101, 71, -24, -103, -39, -84, 51, SemWifiApSmartUtil.BLE_BATT_3, 92, -76}, new byte[]{-10, 102, -60, 84, 28, 44, 90, -83, -86, -28, 12, -90, 57, -54, 114, -42, -61, 35, -85, -4, 7, 96, -70, -29, -66, SemWifiApSmartUtil.BLE_BATT_3, -36, 50, 46, 3, -108, -52}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getName(new ISehSupplicantIface.getNameCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIface.Stub.C08291 */

                        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantIface.getNameCallback
                ...
                case 2:
                    ...
                    getType(new ISehSupplicantIface.getTypeCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIface.Stub.C08302 */

                        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantIface.getTypeCallback
                ...
                case 3:
                    ...
                    getNetwork(_hidl_request.readInt32(), new ISehSupplicantIface.getNetworkCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIface.Stub.C08313 */
                ...
                case 13:
                    ...
                    sehGetPeerAttribute(element, peerAddress2, new sehGetPeerAttributeCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIface.Stub.C08324 */
                ...
                case 14:
                    ...
                    sehGetPeerInfo(_hidl_request.readString(), new sehGetPeerInfoCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantP2pIface.Stub.C08335 */
