...
public interface ISehSupplicantStaIface extends ISehSupplicantIface {
    ...
    static default ISehSupplicantStaIface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default ISehSupplicantStaIface castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default ISehSupplicantStaIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default ISehSupplicantStaIface getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default ISehSupplicantStaIface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default ISehSupplicantStaIface getService() throws RemoteException {
    ...
    public static final class Proxy implements ISehSupplicantStaIface {
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantIface, vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaIface, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaIface
        ...
        public SupplicantStatus updateCellularCapabilities(byte state, byte type, byte scale, byte[] cellId) throws RemoteException {
            ...
            _hidl_blob.putInt8Array(0, cellId);
    ...
    public static abstract class Stub extends HwBinder implements ISehSupplicantStaIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehSupplicantStaIface.kInterfaceName, ISehSupplicantIface.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-65, 61, 15, 113, 2, SemWifiApSmartUtil.BLE_BATT_4, 43, 119, -5, 89, -3, 89, 80, -78, -49, 121, 42, -96, -37, 93, -3, -35, -98, -66, -97, 126, 98, -122, 81, -33, 0, -122}, new byte[]{-10, 102, -60, 84, 28, 44, 90, -83, -86, -28, 12, -90, 57, -54, 114, -42, -61, 35, -85, -4, 7, 96, -70, -29, -66, SemWifiApSmartUtil.BLE_BATT_3, -36, 50, 46, 3, -108, -52}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getName(new ISehSupplicantIface.getNameCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaIface.Stub.C08341 */
                ...
                case 2:
                    ...
                    getType(new ISehSupplicantIface.getTypeCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaIface.Stub.C08352 */
                ...
                case 3:
                    ...
                    getNetwork(_hidl_request.readInt32(), new ISehSupplicantIface.getNetworkCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaIface.Stub.C08363 */
                ...
                case 5:
                    ...
                    getExtendedInfomation(_hidl_request.readString(), new getExtendedInfomationCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaIface.Stub.C08374 */
