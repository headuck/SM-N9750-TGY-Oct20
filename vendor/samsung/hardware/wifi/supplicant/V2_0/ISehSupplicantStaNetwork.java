...
public interface ISehSupplicantStaNetwork extends ISehSupplicantNetwork {
    ...
    @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantNetwork, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    static default ISehSupplicantStaNetwork asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default ISehSupplicantStaNetwork castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default ISehSupplicantStaNetwork getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default ISehSupplicantStaNetwork getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default ISehSupplicantStaNetwork getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default ISehSupplicantStaNetwork getService() throws RemoteException {
    ...
    public static final class BssParam {
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            _hidl_blob.copyToInt8Array(_hidl_offset + 0, this.bssid, 6);
            ...
            _hidl_blob.copyToInt8Array(_hidl_offset + 24, this.tsf, 8);
            _hidl_blob.copyToInt8Array(_hidl_offset + 32, this.age, 8);
            ...
            this.freq = _hidl_blob.getInt32(_hidl_offset + 56);
        }
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            _hidl_blob.putInt32(_hidl_offset + 56, this.freq);
        }
    }
    ...
    public static final class Proxy implements ISehSupplicantStaNetwork {
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork, vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantNetwork, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantNetwork
        ...
        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork
    ...
    public static abstract class Stub extends HwBinder implements ISehSupplicantStaNetwork {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISehSupplicantStaNetwork.kInterfaceName, ISehSupplicantNetwork.kInterfaceName, IBase.kInterfaceName));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getId(new ISehSupplicantNetwork.getIdCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08381 */

                        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantNetwork.getIdCallback
                ...
                case 2:
                    ...
                    getInterfaceName(new ISehSupplicantNetwork.getInterfaceNameCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08442 */

                        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantNetwork.getInterfaceNameCallback
                ...
                case 3:
                    ...
                    getType(new ISehSupplicantNetwork.getTypeCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08453 */

                        @Override // vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantNetwork.getTypeCallback
                ...
                case 12:
                    ...
                    getVendorSsidValue(new getVendorSsidValueCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08464 */
                ...
                case 13:
                    ...
                    getAutoReconnectValue(new getAutoReconnectValueCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08475 */
                ...
                case 15:
                    ...
                    getSimIndex(new getSimIndexCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08486 */
                ...
                case 16:
                    ...
                    getEapMethod(new getEapMethodCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08497 */
                ...
                case 17:
                    ...
                    getEapPhase1Method(new getEapPhase1MethodCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08508 */
                ...
                case 18:
                    ...
                    getEapPacFile(new getEapPacFileCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C08519 */
                ...
                case 19:
                    ...
                    getWapiPskType(new getWapiPskTypeCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C083910 */
                ...
                case 20:
                    ...
                    getWapiCertFormat(new getWapiCertFormatCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C084011 */
                ...
                case ISupplicantStaIfaceCallback.ReasonCode.UNSUPPORTED_RSN_IE_VERSION:
                    ...
                    getWapiAsCert(new getWapiAsCertCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C084112 */
                ...
                case 22:
                    ...
                    getWapiUserCert(new getWapiUserCertCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C084213 */
                ...
                case 23:
                    ...
                    getBss(new getBssCallback() {
                        /* class vendor.samsung.hardware.wifi.supplicant.V2_0.ISehSupplicantStaNetwork.Stub.C084314 */
