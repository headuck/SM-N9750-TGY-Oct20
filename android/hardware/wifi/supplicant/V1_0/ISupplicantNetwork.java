...
public interface ISupplicantNetwork extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantNetwork {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-51, -96, SemWifiApSmartUtil.BLE_BATT_2, 8, -64, 105, 34, -6, 55, -63, 33, 62, -101, -72, 49, -95, 9, -77, 23, 69, 50, Byte.MIN_VALUE, 86, 22, -5, 113, 97, -19, -60, 3, -122, 111}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                getId(new getIdCallback() {
                    /* class android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork.Stub.C01521 */
                ...
                getInterfaceName(new getInterfaceNameCallback() {
                    /* class android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork.Stub.C01532 */
                ...
                getType(new getTypeCallback() {
                    /* class android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork.Stub.C01543 */
