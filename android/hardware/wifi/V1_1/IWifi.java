...
public interface IWifi extends android.hardware.wifi.V1_0.IWifi {
    ...
    public static abstract class Stub extends HwBinder implements IWifi {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-62, 100, 115, -30, -28, -96, 10, -12, 62, SemWifiApSmartUtil.BLE_BATT_5, -96, -35, -7, 0, 46, 80, 98, -89, -48, -108, 4, 41, -27, -17, -74, -27, 81, 58, -118, -68, -73, 92}, new byte[]{-71, -66, 54, 113, -102, -118, -43, 52, 0, 10, 81, -22, 7, -66, -111, -66, -108, -60, 5, -65, 30, 3, -118, -24, 37, -84, -10, 80, -121, -1, -45, 120}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                ...
                case 5:
                    ...
                    getChipIds(new IWifi.getChipIdsCallback() {
                        /* class android.hardware.wifi.V1_1.IWifi.Stub.C00461 */
                ...
                case 6:
                    ...
                    getChip(_hidl_request.readInt32(), new IWifi.getChipCallback() {
                        /* class android.hardware.wifi.V1_1.IWifi.Stub.C00472 */
