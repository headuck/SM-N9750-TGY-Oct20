...
public interface IWifiNanIface extends android.hardware.wifi.V1_0.IWifiNanIface {
    ...
    public static abstract class Stub extends HwBinder implements IWifiNanIface {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-116, 126, -13, 47, -57, -115, 94, -58, -26, -107, 109, -29, 120, 76, -62, -58, -12, 38, 20, -75, 39, 45, 46, 70, 31, 109, 96, 83, 75, -93, -114, -62}, new byte[]{-70, 90, -89, 79, 27, -89, 20, -16, 9, 56, 100, 34, 121, 35, 73, SemWifiApSmartUtil.BLE_BATT_5, 8, 121, 91, -38, 97, -103, -60, -22, 8, -111, 50, 45, 39, -8, -55, 49}, new byte[]{107, -102, -44, 58, 94, -5, -26, -54, 33, 79, 117, 30, 34, -50, 67, -49, 92, -44, -43, -43, -14, -53, -88, 15, 36, -52, -45, 117, 90, 114, SemWifiApSmartUtil.BLE_WIFI, 28}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getType(new IWifiIface.getTypeCallback() {
                        /* class android.hardware.wifi.V1_2.IWifiNanIface.Stub.C00941 */
                ...
                case 2:
                    ...
                    getName(new IWifiIface.getNameCallback() {
                        /* class android.hardware.wifi.V1_2.IWifiNanIface.Stub.C00952 */
