...
public interface IWifiChip extends IBase {
    ...
    public static final class ChipMode {
        ...
        public final int hashCode() {
            return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f0id))), Integer.valueOf(HidlSupport.deepHashCode(this.availableCombinations)));
        }
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            this.f0id = _hidl_blob.getInt32(_hidl_offset + 0);
    ...
    public static abstract class Stub extends HwBinder implements IWifiChip {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-13, -18, -52, 72, -99, -21, 76, 116, -119, 47, 89, -21, 122, -37, 118, -112, 99, -67, 92, 53, 74, -63, 50, -74, 38, -91, -12, 43, 54, 61, 54, -68}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, SemWifiApSmartUtil.BLE_BATT_3, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getId(new getIdCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00051 */
                ...
                case 3:
                    ...
                    getCapabilities(new getCapabilitiesCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00162 */
                ...
                case 4:
                    ...
                    getAvailableModes(new getAvailableModesCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00203 */
                ...
                case 6:
                    ...
                    getMode(new getModeCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00214 */
                ...
                case 7:
                    ...
                    requestChipDebugInfo(new requestChipDebugInfoCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00225 */
                ...
                case 8:
                    ...
                    requestDriverDebugDump(new requestDriverDebugDumpCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00236 */
                ...
                case 9:
                    ...
                    requestFirmwareDebugDump(new requestFirmwareDebugDumpCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00247 */
                ...
                case 10:
                    ...
                    createApIface(new createApIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00258 */
                ...
                case 11:
                    ...
                    getApIfaceNames(new getApIfaceNamesCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C00269 */
                ...
                case 12:
                    ...
                    getApIface(_hidl_request.readString(), new getApIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C000610 */
                ...
                case 14:
                    ...
                    createNanIface(new createNanIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C000711 */
                ...
                case 15:
                    ...
                    getNanIfaceNames(new getNanIfaceNamesCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C000812 */
                ...
                case 16:
                    ...
                    getNanIface(_hidl_request.readString(), new getNanIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C000913 */
                ...
                case 18:
                    ...
                    createP2pIface(new createP2pIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001014 */
                ...
                case 19:
                    ...
                    getP2pIfaceNames(new getP2pIfaceNamesCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001115 */
                ...
                case 20:
                    ...
                    getP2pIface(_hidl_request.readString(), new getP2pIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001216 */
                ...
                case 22:
                    ...
                    createStaIface(new createStaIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001317 */
                ...
                case 23:
                    ...
                    getStaIfaceNames(new getStaIfaceNamesCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001418 */
                ...
                case 24:
                    ...
                    getStaIface(_hidl_request.readString(), new getStaIfaceCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001519 */
                ...
                case 26:
                    ...
                    createRttController(IWifiIface.asInterface(_hidl_request.readStrongBinder()), new createRttControllerCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001720 */
                ...
                case 27:
                    ...
                    getDebugRingBuffersStatus(new getDebugRingBuffersStatusCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001821 */
                ...
                case 31:
                    ...
                    getDebugHostWakeReasonStats(new getDebugHostWakeReasonStatsCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiChip.Stub.C001922 */
