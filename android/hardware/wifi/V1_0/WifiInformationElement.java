...
public final class WifiInformationElement {
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.f5id))), Integer.valueOf(HidlSupport.deepHashCode(this.data)));
    }

    public final String toString() {
        return "{" + ".id = " + ((int) this.f5id) + ", .data = " + this.data + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.f5id = _hidl_blob.getInt8(_hidl_offset + 0);
