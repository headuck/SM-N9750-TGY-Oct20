...
public class SemInsyncService extends ISemInsyncManager.Stub implements AbsSemSystemService {
    ...
    private static final String TAG = SemInsyncService.class.getSimpleName();
    ...
    public class MainHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                SemInsyncService.this.mUserHandle = msg.arg1;
    ...
    private void tryToSendMessageToBindMcfService(int delayMillis) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void unbindMcfService() {
        Log.d(TAG, "unbindMcfService ");
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void bindMcfService() {
