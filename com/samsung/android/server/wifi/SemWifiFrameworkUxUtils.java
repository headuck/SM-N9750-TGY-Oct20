...
public class SemWifiFrameworkUxUtils {
    ...
    public static void showEapToastVzw(Context context, int eapCode) {
        ...
        switch (eapCode) {
            case EAP_NOTIFICATION_VERIZON_WIFI_ERROR_OUTSIDE_COVERAGE /*{ENCODED_INT: 32760}*/:
                Toast.makeText(context, 17042614, 1).show();
                return;
            case EAP_NOTIFICATION_VERIZON_WIFI_ERROR_NOT_SUBSCRIBED /*{ENCODED_INT: 32761}*/:
                Toast.makeText(context, 17042613, 1).show();
                return;
            case EAP_NOTIFICATION_VERIZON_WIFI_ERROR_ACCESS_ACCOUNT /*{ENCODED_INT: 32762}*/:
            case EAP_NOTIFICATION_VERIZON_WIFI_ERROR_ACCESS_ACCOUNT2 /*{ENCODED_INT: 32765}*/:
                Toast.makeText(context, 17042615, 1).show();
                return;
            case EAP_NOTIFICATION_VERIZON_WIFI_ERROR_ALREADY_CONNECTED /*{ENCODED_INT: 32763}*/:
                Toast.makeText(context, 17042611, 1).show();
                return;
            case EAP_NOTIFICATION_VERIZON_WIFI_ERROR_CONNECTING /*{ENCODED_INT: 32764}*/:
                Toast.makeText(context, 17042612, 1).show();
                return;
            case EAP_NOTIFICATION_VERIZON_WIFI_ERROR_NOT_AVAILABLE_LOCATION /*{ENCODED_INT: 32766}*/:
    ...
    public static void showToast(Context context, int infoType, String extraString) {
        if (infoType == 1) {
            ...
            if ("#DEAD00".equals(colorText)) {
                Toast.makeText(context, res.getString(17042658, extraString), 0).show();
                return;
            }
            try {
                Toast toast2 = Toast.makeText(context, Html.fromHtml(res.getString(17042658, "<font color=" + colorText + ">" + Html.escapeHtml(extraString) + "</font>")), 0);
    ...
    /* JADX INFO: Multiple debug info for r0v3 java.lang.String: [D('packageName' java.lang.String), D('intent' android.content.Intent)] */
