...
public class RoamingChannelList {
    ...
    private static final String TAG = RoamingChannelList.class.getSimpleName();
    ...
    private final Comparator<ChannelData> mChannelDataComparator = new Comparator<ChannelData>() {
        /* class com.samsung.android.server.wifi.RoamingChannelList.C07221 */
    ...
    public static class HitArray {
        ...
        public JSONObject toJson(int frequency) {
            ...
            try {
                ...
                String str = RoamingChannelList.TAG;
                Log.e(str, "error in HitArray toJson" + e.getMessage());
            }
            return json;
        }
    ...
    public List<Integer> getFrequentlyUsedChannel(int count) {
        ...
        if (scanner == null) {
            ...
            if (str == null || !str.equals(code)) {
                Log.d(TAG, String.format(Locale.ENGLISH, "mCountryCode is changed [ %s > %s ]", this.mCountryCode, code));
    ...
    public String toString() {
        ...
        return String.format(Locale.ENGLISH, "NetworkKey: %s, slotIdx: %d, LastUpdatedTime: %d, RemainTime = %d\n%s", this.mNetworkKey, Integer.valueOf(this.mSlotIdx), Long.valueOf(this.mLastUpdatedTime), Long.valueOf(this.mRemainingTime), buf.toString());
    }
