...
public class WifiLowLatency extends Handler {
    ...
    private static boolean mEanbledTrafficPoll = false;
    ...
    private static int mTrafficPollCnt = 0;
    private static int mTrafficPollToken = 0;
    private static boolean mVerboseLoggingEnabled = false;
    private ConnectedApInfo mApInfo;
    private final ClientModeImpl mClientModeImpl;
    private final Context mContext;
    private LlHandler mLlHandler;
    ...
    private boolean mTrafficMode = false;
    ...
    private final IUsageStatsWatcher.Stub mUsageStatsWatcher = new IUsageStatsWatcher.Stub() {
        /* class com.samsung.android.server.wifi.WifiLowLatency.C07464 */
            ...
            if (resumeComponentName == null) {
                ...
                if (focusedStack != null) {
                    ...
                    if (!WifiLowLatency.this.mUsageStatsPackageName.equals(packageName2)) {
                        ApplicationInfo appInfo = WifiLowLatency.this.getPackageManager().getApplicationInfo(packageName2, 128);
                        WifiLowLatency.this.mUsageStatsUid = appInfo.uid;
                        WifiLowLatency.this.mUsageStatsPackageName = packageName2;
                        if (!WifiTransportLayerUtils.isLauchablePackage(WifiLowLatency.this.mContext, packageName2)) {
                            ...
                            WifiLowLatency.this.mUsageStatsUid = 0;
                        }
    ...
    private HashMap<String, Boolean> mWhitelistApp;
    ...
    public WifiLowLatency(Context context, WifiNative wifiNative) {
        ...
        this.mContext.registerReceiver(new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.WifiLowLatency.C07431 */
    ...
    public class LlHandler extends Handler {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (WifiLowLatency.mEanbledTrafficPoll) {
                        ...
                        WifiLowLatency.this.mTrafficMode = false;
                        return;
                    } else {
                        return;
                    }
    ...
    private void initialize() {
        if (!mReady) {
            ...
            this.mContext.registerReceiver(new BroadcastReceiver() {
                /* class com.samsung.android.server.wifi.WifiLowLatency.C07442 */

                public void onReceive(Context context, Intent intent) {
                    if (intent.getAction().equals("android.net.wifi.STATE_CHANGE")) {
                        WifiLowLatency.this.mNetworkInfo = (NetworkInfo) intent.getParcelableExtra("networkInfo");
                        ...
                        WifiLowLatency.this.mScreenOn = false;
                    } else if (intent.getAction().equals("android.intent.action.SCREEN_ON")) {
                        WifiLowLatency.this.mScreenOn = true;
                    }
                    WifiLowLatency.this.evaluateTrafficPolling();
                }
            }, filter);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void evaluateTrafficPolling() {
        Message msg;
    ...
    private void regAudioPlaybackCallback() {
        ...
        try {
            am.registerAudioPlaybackCallback(new AudioManager.AudioPlaybackCallback() {
                /* class com.samsung.android.server.wifi.WifiLowLatency.C07453 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean getStateVoipCalling() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean getStateWhitelistAppRunning() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setStateLowLatency(int state, int enable) {
        int i;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void checkEnterpriseNetworkFromScanResults() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void checkEnterpriseNetworkFromRcl() {
        List<Integer> rcl;
        if (!this.mApInfo.isEnterpriseNetwork) {
    ...
    private void logLatencyMode(long now, int mode, int reason) {
        try {
            ...
            String s = String.format(Locale.US, "%s,%d,%d", timestamp, Integer.valueOf(mode), Integer.valueOf(reason));
