...
public class SemWifiHiddenNetworkTracker {
    ...
    private WifiHiddenNetworkAdapter mAdapter;
    private Context mContext;
    private WifiConfiguration mHiddenConfig;
    private boolean mIsTracking;
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        /* class com.samsung.android.server.wifi.SemWifiHiddenNetworkTracker.C07301 */
    ...
    private void showAddNetworkFailNoti() {
        if (this.mIsTracking) {
