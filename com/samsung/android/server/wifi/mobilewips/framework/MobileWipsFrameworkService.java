...
public class MobileWipsFrameworkService {
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        /* class com.samsung.android.server.wifi.mobilewips.framework.MobileWipsFrameworkService.C07514 */

        public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
            if (action.equals("android.intent.action.BOOT_COMPLETED")) {
                Log.d(MobileWipsFrameworkService.TAG, "received ACTION_BOOT_COMPLETED");
                MobileWipsFrameworkService.this.mBootCompleted = true;
                MobileWipsFrameworkService.this.turnOnWips(5000);
            } else if ("android.net.wifi.WIFI_STATE_CHANGED".equals(action)) {
                int state = intent.getIntExtra("wifi_state", -1);
                MobileWipsFrameworkService.this.mIsConnected = false;
                if (state == 1) {
    ...
    private BroadcastReceiver mBroadcastReceiverPackage = new BroadcastReceiver() {
        /* class com.samsung.android.server.wifi.mobilewips.framework.MobileWipsFrameworkService.C07536 */
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (uri != null && MobileWipsFrameworkService.MWIPS_PACKAGE.equals(uri.getSchemeSpecificPart())) {
                ...
                if (c != 0 && c == 1) {
                    MobileWipsFrameworkService.this.turnOnWips();
                    MobileWipsFrameworkService.this.mRetrycount = 0;
                }
            }
        }
    };
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        /* class com.samsung.android.server.wifi.mobilewips.framework.MobileWipsFrameworkService.ServiceConnectionC07503 */
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mobileWipsFrameworkService.mWifiManager = (WifiManager) mobileWipsFrameworkService.mContext.getSystemService("wifi");
            MobileWipsFrameworkService mobileWipsFrameworkService2 = MobileWipsFrameworkService.this;
            mobileWipsFrameworkService2.mConnectivityManager = (ConnectivityManager) mobileWipsFrameworkService2.mContext.getSystemService("connectivity");
            if (MobileWipsFrameworkService.this.mService == null) {
                MobileWipsFrameworkService.this.mService = IMobileWipsService.Stub.asInterface(service);
            }
            if (MobileWipsFrameworkService.this.mService != null) {
                try {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            if (MobileWipsFrameworkService.this.mService != null) {
                MobileWipsFrameworkService.this.mService = null;
            }
    ...
    private MobileWipsDnsRequester mDnsRequester = null;
    private boolean mIsConnected = false;
    private MobileWipsNetdEvent mMobileWipsNetdEvent = null;
    private MobileWipsWifiScanner mMobileWipsWifiScanner = null;
    ...
    IMobileWipsPacketSender mPacketSenderFrameworkApi = new IMobileWipsPacketSender.Stub() {
        /* class com.samsung.android.server.wifi.mobilewips.framework.MobileWipsFrameworkService.BinderC07492 */
        ...
        public byte[] sendDns(long[] timeoutMillis, byte[] srcAddr, byte[] dstAddr, byte[] dnsMessage, String dstMac, boolean isUDP) throws RemoteException {
            ...
            LinkProperties linkProperties = MobileWipsFrameworkService.this.mConnectivityManager.getLinkProperties(network);
            if (linkProperties != null) {
                return MobileWipsFrameworkService.this.mPacketSender.sendDns(linkProperties, srcAddr, dstAddr, dstMac, dnsMessage, timeoutMillis, isUDP);
            }
            return ret;
        }
        ...
        public boolean pingTcp(byte[] srcAddr, byte[] dstAddr, int dstPort, int ttl, int timeoutMillis) throws RemoteException {
            return MobileWipsFrameworkService.this.mPacketSender.pingTcp(srcAddr, dstAddr, dstPort, ttl, timeoutMillis);
        }
    };
    private int mRetrycount = 0;
    private boolean mScanStarted = false;
    private SemHqmManager mSemHqmManager = null;
    private IMobileWipsService mService = null;
    private WifiManager mWifiManager = null;
    private WifiNative mWifiNative = null;
    IMobileWipsFramework mWipsFrameworkApi = new IMobileWipsFramework.Stub() {
        /* class com.samsung.android.server.wifi.mobilewips.framework.MobileWipsFrameworkService.BinderC07481 */
    ...
    private ContentObserver mWipsObserver = new ContentObserver(new Handler()) {
        /* class com.samsung.android.server.wifi.mobilewips.framework.MobileWipsFrameworkService.C07525 */

        public void onChange(boolean selfChange) {
            MobileWipsFrameworkService mobileWipsFrameworkService = MobileWipsFrameworkService.this;
            mobileWipsFrameworkService.mWipsValue = mobileWipsFrameworkService.getWipsValue();
    ...
    public final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            int i = msg.what;
            if (i == 7) {
                MobileWipsFrameworkService.this.mIsConnected = true;
            } else if (i == 40) {
                ...
                if (i != 9) {
                    if (i == 10) {
                        ...
                        MobileWipsFrameworkService.this.mScanStarted = true;
                    } else if (i == 13) {
                        MobileWipsFrameworkService.this.mScanStarted = false;
    ...
    private void monitorWipsStatus() {
        int wipsPid;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void checkSpecialNetwork(boolean remove) {
        if (remove) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void removeSpecialSsidInternal() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private synchronized void startWipsService() {
        int i;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private synchronized void stopWipsService() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setWipsValue(int index) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private int getWipsValue() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), "wifi_mwips", !SemCscFeature.getInstance().getBoolean(CscFeatureTagWifi.TAG_CSCFEATURE_WIFI_DISABLEDEFAULTMWIPS) ? 1 : 0);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void turnOnWips() {
        turnOnWips(0);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void turnOnWips(int interval) {
        int i = this.mWipsValue;
        if (i == 0 || i == 2) {
    ...
    public void registerPackageReciever() {
        ...
        this.mContext.registerReceiver(this.mBroadcastReceiverPackage, intentFilter, null, null);
