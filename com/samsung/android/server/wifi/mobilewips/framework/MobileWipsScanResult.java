...
public class MobileWipsScanResult implements Parcelable {
    ...
    public static final Parcelable.Creator<MobileWipsScanResult> CREATOR = new Parcelable.Creator<MobileWipsScanResult>() {
        /* class com.samsung.android.server.wifi.mobilewips.framework.MobileWipsScanResult.C07551 */
        ...
        public MobileWipsScanResult createFromParcel(Parcel in) {
            ...
            boolean z = true;
            if (in.readInt() == 1) {
                mobileWipsWifiSsid = MobileWipsWifiSsid.CREATOR.createFromParcel(in);
            }
            MobileWipsScanResult sr = new MobileWipsScanResult(mobileWipsWifiSsid, in.readString(), in.readString(), in.readLong(), in.readInt(), in.readString(), in.readInt(), in.readInt(), in.readLong(), in.readInt(), in.readInt(), in.readInt(), in.readInt(), in.readInt(), false);
            sr.seen = in.readLong();
            ...
            if (n != 0) {
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    sr.informationElements[i].f56id = in.readInt();
            ...
            if (n4 != 0) {
                ...
                for (int i4 = 0; i4 < n4; i4++) {
                    ...
                    sr.radioChainInfos[i4].f57id = in.readInt();
                    sr.radioChainInfos[i4].level = in.readInt();
                }
            }
            sr.wifiMode = in.readInt();
            sr.semVendorSpecificInfo = in.readString();
            sr.semBssLoadElement = in.readString();
            sr.semKtVendorSpecificInfo = in.readString();
            return sr;
        }
    ...
    public static class RadioChainInfo {
        ...
        public int hashCode() {
            return Objects.hash(Integer.valueOf(this.f57id), Integer.valueOf(this.level));
        }
    }
