...
public class MobileWipsWifiScanner {
    ...
    public void stop() {
        ...
        this.mWipsScannerHandler.removeCallbacksAndMessages(null);
    }
    ...
    private void doPartialScan(int freq, String karmaSsid, String fKarmaSsid, String fKarmaOriginSsid) {
        if (!mStarted) {
    ...
    /* access modifiers changed from: private */
    public static class PartialScanListener implements WifiScanner.ScanListener {
        ...
        public void onResults(WifiScanner.ScanData[] scanDatas) {
            if (!MobileWipsWifiScanner.mStarted) {
                ...
                try {
                    ScanResult[] results = scanDatas[0].getResults();
