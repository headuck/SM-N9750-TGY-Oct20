...
public class PasspointDefaultProvider {
    ...
    private static final ArrayList<PasspointConfiguration> mDefaultProvderConfigList = new ArrayList<>();
    private static boolean mIsloadInternalDataCompleted = false;
    private static int mNeedtoUpdateProviderConfig = 0;
    ...
    private int mPreviousSimState = 0;
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        /* class com.samsung.android.server.wifi.hotspot2.PasspointDefaultProvider.C07471 */
            ...
            if (action.equals("android.intent.action.SIM_STATE_CHANGED") || action.equals("android.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGED")) {
                ...
                if (currentSimState == 5 && currentSimState != PasspointDefaultProvider.this.mPreviousSimState) {
                    ...
                    if (TextUtils.isEmpty(imsi) || !PasspointDefaultProvider.mIsloadInternalDataCompleted) {
                        PasspointDefaultProvider.this.mPreviousSimState = 6;
                        return;
                    }
                ...
                PasspointDefaultProvider.this.mPreviousSimState = currentSimState;
                ...
                if (PasspointDefaultProvider.mIsloadInternalDataCompleted) {
                    ...
                    int unused = PasspointDefaultProvider.mNeedtoUpdateProviderConfig = 2;
                    return;
                }
                int unused2 = PasspointDefaultProvider.mNeedtoUpdateProviderConfig = 1;
                ...
                if (intent.getBooleanExtra("passpointConfiguration", false) && !PasspointDefaultProvider.mIsloadInternalDataCompleted) {
                    ...
                    boolean unused4 = PasspointDefaultProvider.mIsloadInternalDataCompleted = true;
                }
    ...
    private boolean readPasspointCredendtialFile(File path, int providerType) {
        if (!path.exists()) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void addDefaultProviderConfiguration() {
        int i = 0;
        Iterator<PasspointConfiguration> it = mDefaultProvderConfigList.iterator();
        while (it.hasNext()) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void checkAndUpdateDefaultProviderConfiguration() {
        boolean ret;
        int i = 0;
        ...
        while (it.hasNext()) {
            ...
            if (vendorFqdn != null) {
                ...
                if (!isMatched && (ret = this.mWifiServiceImpl.addOrUpdatePasspointConfiguration(provderConfig, "SamsungPasspoint"))) {
                    logv(TAG, "checkAndUpdateDefaultProviderConfiguration, mDefaultProvderConfigList (" + i + ") " + provderConfig.getHomeSp().getFqdn() + ", add: " + ret);
                }
                i++;
            }
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void removeOldPasspointConfig() {
        List<PasspointConfiguration> savedPasspointConfigs = this.mWifiServiceImpl.getPasspointConfigurations("SamsungPasspoint");
        if (savedPasspointConfigs != null) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void dropFile(File path) {
        if (path.exists()) {
            if (DBG) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateSimCredential(String imsi) {
        int i = 0;
        List<PasspointConfiguration> savedPasspointConfigs = this.mWifiServiceImpl.getPasspointConfigurations("SamsungPasspoint");
        if (savedPasspointConfigs != null) {
            if (DBG) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updatePasspointSettings() {
