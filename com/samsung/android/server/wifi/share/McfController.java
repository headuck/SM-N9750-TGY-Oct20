...
public class McfController {
    ...
    private IMcfServiceState mListener;
    private McfAdapter mMcfAdapter = null;
    private McfAdapter.McfAdapterListener mMcfAdapterListener = new McfAdapter.McfAdapterListener() {
        /* class com.samsung.android.server.wifi.share.McfController.C07601 */
        ...
        public void onServiceConnected(McfAdapter mcfAdapter) {
            ...
            McfController.this.mMcfAdapter = mcfAdapter;
        ...
        public void onServiceDisconnected() {
            ...
            McfController.this.mSemCasterManager.closeCaster(McfController.this.mMcfAdapter);
            McfController.this.mSemSubscriberManager.closeSubscriber(McfController.this.mMcfAdapter);
            McfController.this.mMcfAdapter = null;
        }
    ...
    private final SemCasterManager mSemCasterManager;
    private final SemSubscriberManager mSemSubscriberManager;
