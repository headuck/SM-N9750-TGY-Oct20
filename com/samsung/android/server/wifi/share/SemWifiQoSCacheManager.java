...
public class SemWifiQoSCacheManager {
    ...
    public static class NetworkScoreData {
        ...
        private Map<String, Integer> getNetworkScores() {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private Map<String, Integer> getRealNetworkScores() {
            Map<String, Integer> ret = new HashMap<>();
            ret.put(KEY_NETWORK_TYPE, Integer.valueOf(this.mNetworkType.ordinal()));
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private void update(NetworkType networkType, Speed[] newSpeeds) {
