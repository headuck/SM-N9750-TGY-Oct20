...
public class SemSubscriberManager {
    ...
    private ISubscriberCallback mCallback;
    private int mCountPostAdvertise = 0;
    private final Object mHistoryLock = new Object();
    private boolean mIsNetworkEnabled;
    private boolean mIsPasswordAdvertiseTriggered;
    private boolean mIsPasswordLowLatency;
    private boolean mIsPostAdvertiseStarted;
    private boolean mIsQosLowLatency;
    private boolean mIsScanTriggered;
    private final Map<String, KeepGattDeviceInfo> mKeepGattDeviceList = new HashMap();
    private final Object mLock = new Object();
    private McfSubscriber mMcfSubscriber;
    private int mMode = 0;
    private McfAdvertiseCallback mPassMcfAdvertiseCallback = new McfAdvertiseCallback() {
        /* class com.samsung.android.server.wifi.share.SemSubscriberManager.C07704 */
    ...
    private McfDataUtil.McfData mPasswordData;
    private McfDeviceDiscoverCallback mPasswordDiscoverCallback = new McfDeviceDiscoverCallback() {
        /* class com.samsung.android.server.wifi.share.SemSubscriberManager.C07726 */
        ...
        public void onDeviceDiscovered(McfDevice mcfDevice, int i) {
            ...
            if (i2 == 1) {
                ...
                SemSubscriberManager.this.mReceivedPasswordMcfDevice = mcfDevice;
                ...
                if (mcfDevice.isInContact() != 1) {
                    ...
                    synchronized (SemSubscriberManager.this.mLock) {
                        ...
                        KeepDeviceCallback callback = new KeepDeviceCallback() {
                            /* class com.samsung.android.server.wifi.share.SemSubscriberManager.C07726.C07731 */
                        ...
                        if (SemSubscriberManager.this.mCallback != null) {
                            ISubscriberCallback iSubscriberCallback = SemSubscriberManager.this.mCallback;
                            if (SemSubscriberManager.this.mKeepGattDeviceList.size() <= 0) {
                                z = false;
                            }
                            iSubscriberCallback.onFoundDevicesForPassword(z);
                        }
    ...
    private McfAdvertiseCallback mQoSMcfAdvertiseCallback = new McfAdvertiseCallback() {
        /* class com.samsung.android.server.wifi.share.SemSubscriberManager.C07693 */
    ...
    private McfDeviceDiscoverCallback mQoSMcfDeviceDiscoverCallback = new McfDeviceDiscoverCallback() {
        /* class com.samsung.android.server.wifi.share.SemSubscriberManager.C07715 */
    ...
    private McfDevice mReceivedPasswordMcfDevice;
    private SubscribeCallback mSubscribeCallback = new SubscribeCallback() {
        /* class com.samsung.android.server.wifi.share.SemSubscriberManager.C07682 */
        ...
        public void onMcfServiceStateChanged(int status, int i1) {
            ...
            if (SemSubscriberManager.this.mMcfSubscriber != null && 2 == status && 1 == i1) {
                SemSubscriberManager semSubscriberManager = SemSubscriberManager.this;
                semSubscriberManager.mIsNetworkEnabled = semSubscriberManager.mMcfSubscriber.isNetworkEnabled(1);
            }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void startAdvertise(McfDataUtil.McfData reqInfo) {
        if (!isOpened()) {
    ...
    private void startAdvertiseTo(KeepGattDeviceInfo deviceCallback, McfDataUtil.McfData data, McfController.AdvertiseState state) {
        ...
        McfAdvertiseCallback emptyCallback = new McfAdvertiseCallback() {
            /* class com.samsung.android.server.wifi.share.SemSubscriberManager.C07671 */
        };
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void callbackToClient(McfDevice mcfDevice) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void removeKeepDevice(McfDevice mcfDevice) {
        synchronized (this.mLock) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void addConfirmHistory(String deviceId, JSONObject jsonObject) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isAlreadyConfirmed(String deviceId, JSONObject jsonObject) {
        if (!jsonObject.has(McfDataUtil.McfData.JSON_START_AT)) {
            return false;
        }
        try {
    ...
    /* access modifiers changed from: private */
    public static class KeepGattDeviceInfo {
