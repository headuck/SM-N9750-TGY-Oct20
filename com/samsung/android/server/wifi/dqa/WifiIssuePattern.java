            ...
            if (defaultValue != null) {
                try {
                    if (defaultValue instanceof Boolean) {
                        mReturnValue = (V) Boolean.valueOf(Boolean.parseBoolean(valueString));
                    } else if (defaultValue instanceof Integer) {
                        mReturnValue = (V) Integer.valueOf(Integer.parseInt(valueString));
                    } else if (defaultValue instanceof Long) {
                        mReturnValue = (V) Long.valueOf(Long.parseLong(valueString));
                    } else if (defaultValue instanceof String) {
                        mReturnValue = (V) valueString;
                    }
