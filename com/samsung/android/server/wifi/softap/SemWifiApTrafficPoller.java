...
public class SemWifiApTrafficPoller {
    ...
    private boolean mCurrentL1ssModeValue = false;
    ...
    private boolean mNeedBooster = false;
    private long mRxBytesInterface1;
    private final BroadcastReceiver mSemWifiApTrafficPollerReceiver;
    private SemWifiApTrafficPollerWorkHandler mSemWifiApTrafficPollerWorkHandler = null;
    ...
    private long preTxBytesInterface1 = 0;
    ...
    public SemWifiApTrafficPoller(Context context, WifiNative wifinative) {
        ...
        this.mSemWifiApTrafficPollerReceiver = new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.softap.SemWifiApTrafficPoller.C07981 */
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.net.wifi.WIFI_AP_STATE_CHANGED")) {
                    ...
                    SemWifiApTrafficPoller.this.mWifiManager = (WifiManager) context.getSystemService("wifi");
                    SemWifiApTrafficPoller.this.mWifiManager.getWifiState();
                    if (state == 13) {
                        if (WifiInjector.getInstance().getSemWifiApChipInfo().supportWifiSharing() || WifiInjector.getInstance().getSemWifiApChipInfo().supportWifiSharingLite()) {
                            SemWifiApTrafficPoller.this.mApInterfaceName = "swlan0";
                        } else {
                            SemWifiApTrafficPoller.this.mApInterfaceName = "wlan0";
                        }
                        SemWifiApTrafficPoller.this.mHotspotEnabled = true;
                        ...
                        SemWifiApTrafficPoller.this.mCurrenAffinityMode = 0;
                    } else if (state == 11 || state == 14) {
                        SemWifiApTrafficPoller.this.mHotspotEnabled = false;
                        ...
                        SemWifiApTrafficPoller.this.setPcieIrqAffinity(0);
                        SemWifiApTrafficPoller.this.mCurrentL1ssModeValue = false;
                        SemWifiApTrafficPoller.this.preTxBytesInterface1 = 0;
                        SemWifiApTrafficPoller.this.mNeedBooster = false;
                    }
                    ...
                    if (intent.getIntExtra("NUM", 0) > 0) {
                        if (!SemWifiApTrafficPoller.this.mNeedBooster) {
                            SemWifiApTrafficPoller.this.mNeedBooster = true;
    ...
    public class SemWifiApTrafficPollerWorkHandler extends Handler {
    ...
    private void setPcieIrqAffinity(int mMOde) {
