...
public class SemWifiApPowerSaveImpl {
    ...
    private boolean mElnaEnable;
    private boolean mIsEnabledSoftAp = false;
    private boolean mIsLcdOn = false;
    private Looper mLooper;
    private int mMacAddrAcl;
    private int mMacMaxClient = -1;
    private int mMaxClient;
    private boolean mPacketScheduled;
    private int mPowerSaveChecked = 0;
    private SoftApCallback mSoftApCallback;
    private WakeupMessage mSoftApPacketCheckTimeoutMessage;
    ...
    private long mStartTimeOfHotspot = 0;
    private SoftApPowerSaveStateMachine mStateMachine = null;
    private boolean mStateScheduled;
    private long mTimeofPowersave = 0;
    private boolean mUSBpuggedin;
    ...
    public SemWifiApPowerSaveImpl(Context context) {
        ...
        this.mSoftApReceiver = new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.softap.SemWifiApPowerSaveImpl.C07951 */
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.intent.action.ACTION_POWER_CONNECTED") && SemWifiApPowerSaveImpl.this.mStateMachine != null) {
                    ...
                    SemWifiApPowerSaveImpl.this.mUSBpuggedin = true;
                    ...
                    SemWifiApPowerSaveImpl.this.mUSBpuggedin = false;
                    ...
                    semWifiApPowerSaveImpl.mMacMaxClient = Settings.Secure.getInt(semWifiApPowerSaveImpl.mContext.getContentResolver(), "wifi_ap_number_of_max_macaddr_client", -1);
                    ...
                    SemWifiApPowerSaveImpl.this.mIsLcdOn = true;
                    ...
                    SemWifiApPowerSaveImpl.this.mIsLcdOn = false;
    ...
    public class SoftApCallback implements WifiManager.SoftApCallback {
        ...
        public void onStateChanged(int state, int failureReason) {
            ...
            SemWifiApPowerSaveImpl.this.mWifiApState = state;
            if (SemWifiApPowerSaveImpl.this.mWifiApState == 10 || SemWifiApPowerSaveImpl.this.mWifiApState == 11 || SemWifiApPowerSaveImpl.this.mWifiApState == 14) {
                ...
                SemWifiApPowerSaveImpl.this.mIsEnabledSoftAp = false;
            } else if (SemWifiApPowerSaveImpl.this.mWifiApState == 13) {
                SemWifiApPowerSaveImpl.this.mStartTimeOfHotspot = SystemClock.elapsedRealtime();
                WifiConfiguration mWificonfig = SemWifiApPowerSaveImpl.this.mWifiManager.getWifiApConfiguration();
                SemWifiApPowerSaveImpl semWifiApPowerSaveImpl = SemWifiApPowerSaveImpl.this;
                semWifiApPowerSaveImpl.mMacMaxClient = Settings.Secure.getInt(semWifiApPowerSaveImpl.mContext.getContentResolver(), "wifi_ap_number_of_max_macaddr_client", -1);
                SemWifiApPowerSaveImpl.this.mMacAddrAcl = mWificonfig.macaddrAcl;
                SemWifiApPowerSaveImpl.this.mIsEnabledSoftAp = true;
            }
        }
    ...
    /* access modifiers changed from: private */
    public class SoftApPowerSaveStateMachine extends StateMachine {
        ...
        private final State mPowerSaveAggressiveState = new PowerSaveAggressiveState();
        private final State mPowerSaveNoBeaconModeState = new PowerSaveNoBeaconModeState();
        private final State mPowerSaveState = new PowerSaveState();
        private final State mReadyOneState = new ReadyOneState();
        private final State mReadyThreeState = new ReadyThreeState();
        private final State mReadyTwoState = new ReadyTwoState();
        ...
        private void sendBigdataForHotspotPowerSave(String mStateOfPowersave) {
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 3:
                        SemWifiApPowerSaveImpl.this.NumOfClientsConnected = message.arg1;
        ...
        private class ReadyOneState extends State {
            ...
            public void enter() {
                ...
                SemWifiApPowerSaveImpl.this.mStateScheduled = true;
                SemWifiApPowerSaveImpl.this.mTimeofPowersave = SystemClock.elapsedRealtime();
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    case 0:
                        SemWifiApPowerSaveImpl.this.mStateScheduled = false;
                        SoftApPowerSaveStateMachine softApPowerSaveStateMachine = SoftApPowerSaveStateMachine.this;
                    ...
                    case 3:
                        ...
                        SemWifiApPowerSaveImpl.this.NumOfClientsConnected = message.arg1;
                        SemWifiApPowerSaveImpl.this.mMacMaxClient = Settings.Secure.getInt(SemWifiApPowerSaveImpl.this.mContext.getContentResolver(), "wifi_ap_number_of_max_macaddr_client", -1);
        ...
        private class PowerSaveState extends State {
            ...
            public void enter() {
                ...
                if (SemWifiApPowerSaveImpl.this.mSoftApPacketCheckTimeoutMessage != null) {
                    SemWifiApPowerSaveImpl.this.mPacketScheduled = true;
                ...
                if (SemWifiApPowerSaveImpl.this.mWifiNative != null && SemWifiApPowerSaveImpl.this.NumOfClientsConnected == 0) {
                    ...
                    SemWifiApPowerSaveImpl.this.mElnaEnable = true;
                }
            }
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case 7:
                        SemWifiApPowerSaveImpl.this.mPacketScheduled = false;
                        String staList = null;
                        if (SemWifiApPowerSaveImpl.this.mWifiNative != null) {
            ...
            public void exit() {
                ...
                if (SemWifiApPowerSaveImpl.this.mWifiNative != null && SemWifiApPowerSaveImpl.this.mElnaEnable) {
                    SemWifiApPowerSaveImpl.this.mWifiNative.semSetSoftApElnaEnable(SemWifiApPowerSaveImpl.this.mApInterfaceName, false);
                    SemWifiApPowerSaveImpl.this.mElnaEnable = false;
                }
