...
public class SemWifiApSmartMHS {
    ...
    private boolean isAdvStoppedbecauseOfSIMRemoval;
    private boolean isAdveretizing;
    private boolean isJDMDevice;
    private boolean islowBattery;
    private AdvertiseCallback mAdvertiseCallback;
    private byte mBatteryPct;
    ...
    public SemWifiApSmartMHS(Context context, SemWifiApSmartUtil tSemWifiApBleUtil, WifiDevicePolicyManager sWifiDevicePolicyManager, LocalLog tLocalLog) {
        ...
        this.mAdvertiseCallback = new AdvertiseCallback() {
            /* class com.samsung.android.server.wifi.softap.smarttethering.SemWifiApSmartMHS.C08141 */
            ...
            public void onStartFailure(int errorCode) {
                ...
                LocalLog localLog = SemWifiApSmartMHS.this.mLocalLog;
                localLog.log("SemWifiApSmartMHS:\tMHS Advertise Failed: " + errorCode);
            }
        };
    ...
    public boolean setWifiApSmartMHS(boolean enable) {
        ...
        BleWorkHandler bleWorkHandler = this.mBleWorkHandler;
        if (bleWorkHandler != null) {
            bleWorkHandler.removeCallbacksAndMessages(null);
        }
        sendEmptyMessage(11);
        return true;
    }
            ...
            if (action.equals("android.intent.action.TIME_SET")) {
                ...
                if ("ABSENT".equals(state)) {
                    if (SemWifiApSmartMHS.this.isAdveretizing) {
                        ...
                        SemWifiApSmartMHS.this.isAdvStoppedbecauseOfSIMRemoval = true;
                        if (SemWifiApSmartMHS.this.mBleWorkHandler != null) {
                            SemWifiApSmartMHS.this.mBleWorkHandler.sendEmptyMessage(11);
                        }
                    }
                    ...
                    SemWifiApSmartMHS.this.isAdvStoppedbecauseOfSIMRemoval = false;
                }
                ...
                LocalLog localLog = SemWifiApSmartMHS.this.mLocalLog;
                localLog.log("SemWifiApSmartMHS:\taction BLE state:" + action + "::" + state2);
                if (state2 == 16) {
                ...
                SemWifiApSmartMHS.this.mBatteryPct = (byte) ((level * 100) / intent.getIntExtra("scale", -1));
                ...
                if (val == 1 && !SemWifiApSmartMHS.this.islowBattery && SemWifiApSmartMHS.this.mBatteryPct <= 15) {
                    Log.d(SemWifiApSmartMHS.TAG, "low battery:" + ((int) SemWifiApSmartMHS.this.mBatteryPct) + " ,,isAdveretizing: " + SemWifiApSmartMHS.this.isAdveretizing);
                    SemWifiApSmartMHS.this.islowBattery = true;
                    LocalLog localLog2 = SemWifiApSmartMHS.this.mLocalLog;
                    localLog2.log("SemWifiApSmartMHS:\tlow battery pct:  " + ((int) SemWifiApSmartMHS.this.mBatteryPct) + ",, isAdveretizing: " + SemWifiApSmartMHS.this.isAdveretizing);
                    if (SemWifiApSmartMHS.this.isAdveretizing) {
                        if (SemWifiApSmartMHS.this.mBleWorkHandler != null) {
                            SemWifiApSmartMHS.this.mBleWorkHandler.sendEmptyMessage(11);
                        }
                    ...
                    Log.d(SemWifiApSmartMHS.TAG, "charged from low battery:" + ((int) SemWifiApSmartMHS.this.mBatteryPct) + " ,,isAdveretizing:" + SemWifiApSmartMHS.this.isAdveretizing);
                    SemWifiApSmartMHS.this.islowBattery = false;
                    LocalLog localLog3 = SemWifiApSmartMHS.this.mLocalLog;
                    localLog3.log("SemWifiApSmartMHS:\t change from low battery pct:  " + ((int) SemWifiApSmartMHS.this.mBatteryPct) + " ,,isAdveretizing: " + SemWifiApSmartMHS.this.isAdveretizing);
                    if (SemWifiApSmartMHS.this.isAdveretizing) {
                        if (SemWifiApSmartMHS.this.mBleWorkHandler != null) {
                            SemWifiApSmartMHS.this.mBleWorkHandler.sendEmptyMessage(11);
                        }
                ...
                Settings.Secure.getInt(SemWifiApSmartMHS.this.mContext.getContentResolver(), "wifi_ap_smart_tethering_settings_with_family", 0);
    ...
    private byte[] getMHSAdvManufactureData() {
        ...
        Log.d(TAG, "mBatteryPct:" + ((int) this.mBatteryPct));
        Log.d(TAG, "advData:" + Arrays.toString(advData));
        this.mLocalLog.log("SemWifiApSmartMHS:\t SmartMHS startAdvertizing mBatteryPct : " + ((int) this.mBatteryPct) + ",advData:" + Arrays.toString(advData));
        return advData;
    }
