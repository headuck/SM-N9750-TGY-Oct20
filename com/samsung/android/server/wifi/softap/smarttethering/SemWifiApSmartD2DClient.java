...
public class SemWifiApSmartD2DClient {
    ...
    private static String TAG = "SemWifiApSmartD2DClient";
    ...
    private AdvertiseCallback mAdvertiseCallback = new AdvertiseCallback() {
        /* class com.samsung.android.server.wifi.softap.smarttethering.SemWifiApSmartD2DClient.C08041 */
        ...
        public void onStartFailure(int errorCode) {
            String str = SemWifiApSmartD2DClient.TAG;
            Log.e(str, "client D2D Advertise Failed: " + errorCode);
            LocalLog localLog = SemWifiApSmartD2DClient.this.mLocalLog;
            localLog.log(SemWifiApSmartD2DClient.TAG + ":\tclient D2D Advertise Failed: " + errorCode);
        }
    };
    ...
    private ContentObserver mSemWifiApSmartDeviceNameObserver = new ContentObserver(new Handler()) {
        /* class com.samsung.android.server.wifi.softap.smarttethering.SemWifiApSmartD2DClient.C08052 */

        public void onChange(boolean selfChange) {
            if (SemWifiApSmartD2DClient.this.isAdvRunning) {
                Log.d(SemWifiApSmartD2DClient.TAG, "mSemWifiApSmartDeviceNameObserver");
                LocalLog localLog = SemWifiApSmartD2DClient.this.mLocalLog;
                localLog.log(SemWifiApSmartD2DClient.TAG + ":\tmSemWifiApSmartDeviceNameObserver");
    ...
    class SemWifiApSmartD2DClientReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("com.samsung.android.server.wifi.softap.smarttethering.d2dfamilyid")) {
                ...
                if (SemWifiApSmartD2DClient.this.isAdvRunning) {
                    SemWifiApSmartD2DClient.this.isStartAdvPending = false;
                }
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                if (status != 0 || SemWifiApSmartD2DClient.this.isAdvRunning) {
                    ...
                    LocalLog localLog = SemWifiApSmartD2DClient.this.mLocalLog;
                    localLog.log(SemWifiApSmartD2DClient.TAG + ":\tcheckPreConditions failed " + status);
                    return;
                }
