...
public class SemWifiApContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        return qb.query(this.f60db, projection, selection, selectionArgs, null, null, sortOrder);
    }
    ...
    public static String get(Context mContext, String key) {
        Cursor c = mContext.getContentResolver().query(Uri.parse("content://com.samsung.android.wifi.softap"), null, "name = ?", new String[]{key}, null);
        String returnValue = "";
        if (c != null) {
            try {
                if (c.moveToFirst()) {
