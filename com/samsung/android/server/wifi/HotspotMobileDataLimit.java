...
public class HotspotMobileDataLimit {
    ...
    private CountApData mApData;
    private ContentObserver mApLimitObserver = new ContentObserver(new Handler()) {
        /* class com.samsung.android.server.wifi.HotspotMobileDataLimit.C07182 */
        ...
        public void onChange(boolean selfChange) {
            ...
            hotspotMobileDataLimit.mDataLimited = z;
    ...
    private ContentObserver mApLimitValueObserver = new ContentObserver(new Handler()) {
        /* class com.samsung.android.server.wifi.HotspotMobileDataLimit.C07193 */
        ...
        public void onChange(boolean selfChange) {
            ...
            if (limit != null) {
                HotspotMobileDataLimit.this.mLimitData = new BigDecimal(limit);
            }
        }
    };
    private long mBaseRxBytes;
    private long mBaseTxBytes;
    private final Context mContext;
    private boolean mDataLimited;
    private BigDecimal mLimitData;
    private ContentObserver mMobileDataObserver = new ContentObserver(new Handler()) {
        /* class com.samsung.android.server.wifi.HotspotMobileDataLimit.C07204 */
        ...
        public void onChange(boolean selfChange) {
            ...
            if (true == DataNetworkEnable) {
                HotspotMobileDataLimit.this.isDataConnected = true;
                if (HotspotMobileDataLimit.this.isStarted) {
                    HotspotMobileDataLimit.this.isAgain = true;
                    HotspotMobileDataLimit hotspotMobileDataLimit = HotspotMobileDataLimit.this;
                    hotspotMobileDataLimit.mResumeData = Settings.Secure.getString(hotspotMobileDataLimit.mContext.getContentResolver(), "wifi_ap_mobile_data_usage_value");
            ...
            HotspotMobileDataLimit.this.isDataConnected = false;
            if (HotspotMobileDataLimit.this.mApData.isRunning()) {
                HotspotMobileDataLimit.this.mApData.pause();
            }
        }
    };
    private INetworkManagementService mNM;
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        /* class com.samsung.android.server.wifi.HotspotMobileDataLimit.C07171 */

        public void onReceive(Context context, Intent intent) {
            HotspotMobileDataLimit.this.handleEvent(context, intent);
        }
    };
    private String mResumeData;
    private WifiManager mWifiManager;
    private ContentObserver mWifiSharingObserver = new ContentObserver(new Handler()) {
        /* class com.samsung.android.server.wifi.HotspotMobileDataLimit.C07215 */
        ...
        public void onChange(boolean selfChange) {
            ...
            if (!isWifiSharing && HotspotMobileDataLimit.this.isWifiApEnabled) {
                ...
                if (HotspotMobileDataLimit.this.saveWifiStatus) {
                    HotspotMobileDataLimit.this.getTetheringBytes();
                    HotspotMobileDataLimit.this.saveWifiStatus = false;
                    HotspotMobileDataLimit.this.saveMobileDate = true;
                }
                if (!HotspotMobileDataLimit.this.mApData.isRunning()) {
                    HotspotMobileDataLimit.this.mApData.resume();
                }
    ...
    private boolean saveMobileDate;
    private boolean saveWifiStatus;
    ...
    private void resetApDataUsage() {
        ...
        Settings.Secure.putString(this.mContext.getContentResolver(), "wifi_ap_mobile_data_usage_value", BigDecimal.valueOf(0L).toString());
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void getTetheringBytes() {
        this.mBaseRxBytes = 0;
        this.mBaseTxBytes = 0;
        try {
    ...
    /* access modifiers changed from: private */
    public class CountApData extends Handler {
        ...
        public void resume() {
            ...
            if (!HotspotMobileDataLimit.this.isDataConnected) {
                ...
                hotspotMobileDataLimit.isDataConnected = z;
            }
            if (!hasMessages(0)) {
                sendEmptyMessage(0);
            }
            ...
            if (this.check) {
                ...
                if (!HotspotMobileDataLimit.this.mDataLimited || HotspotMobileDataLimit.this.mLimitData == null) {
                    ...
                    if (usage.compareTo(HotspotMobileDataLimit.this.mLimitData) >= 0) {
                        HotspotMobileDataLimit.this.isReached = true;
                        ...
                        ((WifiManager) HotspotMobileDataLimit.this.mContext.getSystemService("wifi")).semSetWifiApEnabled(null, false);
                    } else {
                        Settings.Secure.putString(HotspotMobileDataLimit.this.mContext.getContentResolver(), "wifi_ap_mobile_data_usage_value", usage.toString());
                    }
                }
