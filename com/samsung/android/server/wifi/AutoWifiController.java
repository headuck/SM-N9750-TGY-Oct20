...
public class AutoWifiController extends StateMachine {
    ...
    private boolean mAlwaysWifiOnUser = true;
    final AutoWifiNotificationController mAutoWifiNotificationController;
    WifiAwareManager mAwareManager;
    ConnectivityManager mConnectivityManager;
    final Context mContext;
    private State mDefaultState = new DefaultState();
    private boolean mDoNotUpdateAlwaysWifiOnUserFlag = false;
    private boolean mDoNotUpdateGeofenceExitDelay = false;
    private boolean mEnableSmartSwitch = false;
    private ArrayList<String> mExceptNetworkKeys = new ArrayList<>();
    ...
    private boolean mIsP2pNetworkConnected = false;
    private long mLastConnectedDuration = 0;
    private String mLastConnectedFavoriteApKey = null;
    private int mLastConnectedNetworkId = -1;
    private int mLastGeofenceState = 2;
    private int mLastReceivedNetworkState = 0;
    private int mLastReportedCellCount = 0;
    private int mLastReportedNetworkIdForCellCount = -1;
    private boolean mLastScreenState = true;
    private long mLastUpdatedGeofenceExitTime = 0;
    AutoWifiListener mListener;
    private boolean mLogMessages = false;
    private boolean mManualGeofenceControl = false;
    private int mMaxBssidWhiteListSize;
    private int mMaxCellIdCount;
    private long mMinDurationToTransitGeofenceExitState = 10000;
    private long mMinDurationToTransitWifiOffState = MAX_DURATION_TIME;
    private long mMinScanResultCountToTransitWifiOffState = 3;
    private long mNextScanInterval = 0;
    ArrayList<ContentObserver> mObservers = new ArrayList<>();
    private long mPeriodicScanMaxInterval = PERIODIC_SCAN_INTERVAL;
    ArrayList<BroadcastReceiver> mReceivers = new ArrayList<>();
    private State mScanModeState = new ScanModeState();
    final ScanResultMatcher mScanResultMatcher;
    private TelephonyManager mTelephonyManager;
    private State mUserTriggeredWifiOffState = new UserTriggeredWifiOffState();
    private State mUserTriggeredWifiOnState = new UserTriggeredWifiOnState();
    ...
    private WifiGeofenceManager.WifiGeofenceStateListener mWifiGeofenceListener = new WifiGeofenceManager.WifiGeofenceStateListener() {
        /* class com.samsung.android.server.wifi.AutoWifiController.C070612 */

        @Override // com.android.server.wifi.WifiGeofenceManager.WifiGeofenceStateListener
    ...
    private State mWifiOffState = new WifiOffState();
    private State mWifiOffWithScanModeState = new WifiOffWithScanModeState();
    private State mWifiOnState = new WifiOnState();
    ...
    private void registerReceiver() {
        BroadcastReceiver receiver = new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07031 */
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (networkInfo != null) {
                    if (networkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) {
                        WifiInfo info = AutoWifiController.this.mAdapter.getWifiInfo();
                        AutoWifiController.this.mLastConnectedNetworkId = info.getNetworkId();
                        currentState = 1;
                    } else {
                        currentState = 0;
                    }
                ...
                if (AutoWifiController.this.mLastReceivedNetworkState != currentState) {
                    AutoWifiController.this.mLastReceivedNetworkState = currentState;
        ...
        if (this.mContext.getPackageManager().hasSystemFeature("android.hardware.wifi.direct")) {
            BroadcastReceiver receiver2 = new BroadcastReceiver() {
                /* class com.samsung.android.server.wifi.AutoWifiController.C07082 */

                public void onReceive(Context context, Intent intent) {
                    AutoWifiController.this.mIsP2pNetworkConnected = ((NetworkInfo) intent.getParcelableExtra("networkInfo")).isConnected();
        ...
        BroadcastReceiver receiver3 = new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07093 */
        ...
        BroadcastReceiver receiver4 = new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07104 */
        ...
        BroadcastReceiver receiver5 = new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07115 */
        ...
        BroadcastReceiver receiver6 = new BroadcastReceiver() {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07126 */
    ...
    private void registerForScanModeChange() {
        ContentObserver contentObserver = new ContentObserver(null) {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07137 */
    ...
    private void registerForAutoWifiModeChange() {
        ContentObserver contentObserver = new ContentObserver(null) {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07148 */
    ...
    private void registerForSmartNetworkSwitchModeChange() {
        ContentObserver contentObserver = new ContentObserver(null) {
            /* class com.samsung.android.server.wifi.AutoWifiController.C07159 */

            public void onChange(boolean selfChange) {
                AutoWifiController autoWifiController = AutoWifiController.this;
                autoWifiController.mEnableSmartSwitch = autoWifiController.getSamrtSwitchModeFromProvider();
            }
        };
    ...
    private void registerForUltraPowerSaving() {
        ContentObserver contentObserver = new ContentObserver(null) {
            /* class com.samsung.android.server.wifi.AutoWifiController.C070410 */
    ...
    private void registerForLocation() {
        ContentObserver contentObserver = new ContentObserver(null) {
            /* class com.samsung.android.server.wifi.AutoWifiController.C070511 */
    ...
    public void checkAndStart() {
        ...
        forceUpdateGeofenceState(z, null);
    ...
    public static /* synthetic */ class C070713 {
    ...
    private boolean setWifiControllerState(WifiState state) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateScoreForCurrentNetwork(boolean connectedViaWifi) {
        if (connectedViaWifi) {
            ...
            this.mAutoWifiNotificationController.setNetworkState(false, false, null, null);
        }
    }
    ...
    public void setWifiEnabledTriggered(boolean enable, String packageName, boolean triggeredByUser) {
        ...
        if (AUTO_WIFI_PACKAGE_NAME.equals(packageName)) {
            ...
            if (triggeredByUser && (networkInfo = this.mAdapter.getNetworkInfo()) != null && networkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) {
                this.mAutoWifiNotificationController.setNetworkState(false, true, null, null);
            }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setGeofenceState(int state, int commonState) {
    ...
    public void setScreenState(boolean on) {
        ...
        sendMessage(obtainMessage(12, on ? 1 : 0, 0));
    }
    ...
    public void setConfigForTest(Bundle configs) {
        int manualMode = configs.getInt("manual_mode", -1);
        if (DBG) {
        ...
        int geofenceState = configs.getInt("geofence_state", -1);
        if (DBG) {
        ...
        int locationState = configs.getInt("location_state", -1);
        if (DBG) {
        ...
        int airplainMode = configs.getInt("airplain_mode", -1);
        if (DBG) {
        ...
        int ultrapowersaveMode = configs.getInt("ultrapowersave_mode", -1);
        if (DBG) {
        ...
        long duration = configs.getLong("max_duration", -1);
        if (DBG) {
        ...
        long duration2 = configs.getLong("max_geofence_exit_duration", -1);
        if (DBG) {
        ...
        long scanInterval = configs.getLong("scan_interval", -1);
        if (DBG) {
        ...
        int scanCount = configs.getInt("scan_counter", -1);
        if (DBG) {
        ...
        int maxCellCount = configs.getInt("cell_counter", -1);
        if (DBG) {
        ...
        int maxBssidCount = configs.getInt("bssid_counter", -1);
        if (DBG) {
            Log.d(TAG, "bssid_counter:" + maxBssidCount);
        }
        if (maxBssidCount > 0) {
            this.mMaxBssidWhiteListSize = maxBssidCount;
        }
        int initScore = configs.getInt("init_score", -1);
        if (initScore >= 0) {
            Log.d(TAG, "init_score : " + initScore);
            sendMessage(obtainMessage(16, initScore, 0));
        }
        long durScore1 = configs.getLong("dur_score_1", -1);
        if (DBG) {
            Log.d(TAG, "duration score 1:" + durScore1);
        }
        long durScore2 = configs.getLong("dur_score_2", -1);
        if (DBG) {
            Log.d(TAG, "duration score 2:" + durScore2);
        }
        long durMinus = configs.getLong("dur_minus", -1);
        if (DBG) {
            Log.d(TAG, "duration minus:" + durMinus);
        }
        long durRecovery = configs.getLong("dur_recovery", -1);
        if (DBG) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean checkDeviceStatusInIdle() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setAutoWifiScoreForAll(int initScore) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setAlwaysWifiOnUserToDb(boolean isAlwaysOnUser) {
        Settings.Global.putInt(this.mContext.getContentResolver(), "sem_auto_wifi_last_user_state", isAlwaysOnUser ? 1 : 0);
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean getAlawaysAllowScanModeFromProvider() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isActivePeerConnection() {
        ...
        if (!this.mIsP2pNetworkConnected) {
            return false;
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean setWifiStateScanMode() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setWifiStateDisableOrScanMode() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void transitWifiOffState(boolean updateWifiState) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void obtainScanAlwaysAvailablePolicy(boolean enable) {
        this.mAdapter.obtainScanAlwaysAvailablePolicy(enable);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setScanAlwaysAvailable(boolean enable) {
        this.mAdapter.setScanAlwaysAvailable(enable);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private int getGeofenceInternalState(int geofenceState) {
        if (geofenceState == 1) {
            return 1;
        }
        if (geofenceState != 2) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void forceUpdateGeofenceState(boolean enterState, String additionalKey) {
        StringBuilder sb = new StringBuilder();
            ...
            switch (msg.what) {
                ...
                case 15:
                    if (AutoWifiController.this.getAutoWifiEnabledFromProvider() && !AutoWifiController.this.mAlwaysWifiOnUser && AutoWifiController.this.checkDeviceStatusInIdle()) {
                        ...
                        AutoWifiController.this.setWifiControllerState(WifiState.WIFI_STATE_ON);
                    }
                    AutoWifiController autoWifiController2 = AutoWifiController.this;
        ...
        public boolean processMessage(Message msg) {
            ...
            if (i != 5) {
                if (i != 7) {
                    ...
                    AutoWifiController.this.mDoNotUpdateAlwaysWifiOnUserFlag = true;
    ...
    class FavoriteGeofenceEnterState extends State {
        ...
        public void enter() {
            AutoWifiController.this.mLastUpdatedGeofenceExitTime = 0;
            if (AutoWifiController.this.mDoNotUpdateAlwaysWifiOnUserFlag) {
                ...
                AutoWifiController.this.mDoNotUpdateAlwaysWifiOnUserFlag = false;
            } else if (AutoWifiController.this.mLastGeofenceState == 1) {
                if (AutoWifiController.this.mAdapter.isWifiToggleEnabled()) {
                    AutoWifiController.this.mAlwaysWifiOnUser = true;
                } else {
                    AutoWifiController.this.mAlwaysWifiOnUser = false;
                }
                AutoWifiController autoWifiController = AutoWifiController.this;
        ...
        public boolean processMessage(Message msg) {
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i != 5) {
                                ...
                                if (AutoWifiController.this.mLastUpdatedGeofenceExitTime != 0 && SystemClock.elapsedRealtime() - AutoWifiController.this.mLastUpdatedGeofenceExitTime >= AutoWifiController.this.mMinDurationToTransitGeofenceExitState) {
                                    ...
                                    if (AutoWifiController.this.mAdapter.isWifiToggleEnabled()) {
                                        if (!AutoWifiController.this.mAlwaysWifiOnUser && !AutoWifiController.this.isActivePeerConnection() && AutoWifiController.this.mScanResultMatcher.getFavoriteNetworkCount() > 0) {
                                            AutoWifiController autoWifiController = AutoWifiController.this;
                                            if (autoWifiController.isFavoriteAp((AutoWifiController) autoWifiController.mLastConnectedNetworkId) || AutoWifiController.this.mLastConnectedDuration < AutoWifiController.UNINTENDED_AP_CONNECTION_TIME) {
                        ...
                        if (AutoWifiController.this.mLastUpdatedGeofenceExitTime == 0) {
                            AutoWifiController.this.mLastUpdatedGeofenceExitTime = SystemClock.elapsedRealtime();
                    ...
                    if (!AutoWifiController.this.mDoNotUpdateGeofenceExitDelay) {
                        if (AutoWifiController.this.getCurrentState() == AutoWifiController.this.mWifiConnectedState) {
                            AutoWifiController.this.mMinDurationToTransitGeofenceExitState = 60000;
                        } else {
                            AutoWifiController.this.mMinDurationToTransitGeofenceExitState = 10000;
                        }
                    }
                    if (msg.arg1 == 1) {
                ...
                AutoWifiController.this.mLastConnectedNetworkId = -1;
                AutoWifiController.this.mLastConnectedDuration = 0;
                AutoWifiController autoWifiController6 = AutoWifiController.this;
    ...
    class ScanModeState extends State {
        ...
        private void startScanPoll() {
            AutoWifiController.this.removeMessages(11);
            AutoWifiController.this.mNextScanInterval = getNextScanInterval(this.mScanCounter);
            AutoWifiController autoWifiController = AutoWifiController.this;
    ...
    /* access modifiers changed from: package-private */
    public class WifiOnState extends State {
    ...
    class WifiConnectedState extends State {
        ...
        public void exit() {
            AutoWifiController.this.mLastConnectedDuration = SystemClock.elapsedRealtime() - this.mTimeAtConnectStart;
        }
            ...
            if (i != 2) {
                if (i != 3) {
                    ...
                    if (AutoWifiController.this.getAlawaysAllowScanModeFromProvider()) {
                        AutoWifiController.this.setWifiControllerState(WifiState.WIFI_STATE_SCANMODE);
                        AutoWifiController autoWifiController = AutoWifiController.this;
    ...
    class WifiOffWithScanModeState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            if (i != 3) {
                ...
                AutoWifiController.this.setWifiControllerState(WifiState.WIFI_STATE_OFF);
                AutoWifiController autoWifiController = AutoWifiController.this;
        ...
        public boolean processMessage(Message msg) {
            ...
            if (i == 2) {
                ...
                if (i != 6) {
                    ...
                    if (!(AutoWifiController.this.mLastConnectedNetworkId == -1 || (config = AutoWifiController.this.mAdapter.getSpecificNetwork(AutoWifiController.this.mLastConnectedNetworkId)) == null || !AutoWifiController.this.isFavoriteAp((AutoWifiController) config))) {
    ...
    /* access modifiers changed from: private */
    public class ScanResultMatcher {
                ...
                synchronized (this.mLockFavoriteNetworkKeys) {
                    ...
                    for (WifiConfiguration config : configs) {
                        if (AutoWifiController.isTargetAp(config)) {
                            if (AutoWifiController.this.isFavoriteAp((AutoWifiController) config)) {
                ...
                for (ScanResult scanItem : scanResults) {
                    if (scanItem != null) {
                        ...
                        if (bssid == null) {
                            ...
                            String[] keys = AutoWifiController.getConfigKeyFrom(scanItem);
                            for (String key : keys) {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private boolean isKTHomeAP(String bssid) {
            List<ScanResult> scanResults = AutoWifiController.this.mAdapter.getScanResults();
            if (scanResults != null) {
                for (ScanResult scanItem : scanResults) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isFavoriteAp(int networkId) {
