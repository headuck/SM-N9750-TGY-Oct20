...
public interface IWifiGuiderService extends IInterface {
    ...
    public static class Default implements IWifiGuiderService {
        @Override // com.samsung.android.net.wifi.wifiguider.IWifiGuiderService
    ...
    public static abstract class Stub extends Binder implements IWifiGuiderService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code == 1) {
                ...
                boolean runDiagnosis = runDiagnosis(data.readString());
                reply.writeNoException();
                reply.writeInt(runDiagnosis ? 1 : 0);
                return true;
            } else if (code == 2) {
                data.enforceInterface(DESCRIPTOR);
                List<String> _result = getDiagnosisResults();
                reply.writeNoException();
        ...
        public static class Proxy implements IWifiGuiderService {
