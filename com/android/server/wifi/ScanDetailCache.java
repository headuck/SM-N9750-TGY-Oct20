...
public class ScanDetailCache {
        ...
        if (currentSize >= this.mTrimSize) {
            ...
            if (list.size() != 0) {
                Collections.sort(list, new Comparator() {
                    /* class com.android.server.wifi.ScanDetailCache.C04041 */
    ...
    private ArrayList<ScanDetail> sort() {
        ...
        if (list.size() != 0) {
            Collections.sort(list, new Comparator() {
                /* class com.android.server.wifi.ScanDetailCache.C04052 */
        ...
        if (list.size() > 0) {
            ...
            while (it.hasNext()) {
                ...
                if (networkDetail != null) {
                    sbuf.append(",");
                    sbuf.append(String.format("Ant=%s", networkDetail.getAnt()));
                    sbuf.append(",");
                    sbuf.append(String.format("Internet=%s", Boolean.valueOf(networkDetail.isInternet())));
                }
