    ...
    private void updateAvgForHDR(int curState) {
        ...
        if (curState == 0 || curState == 2) {
            for (int i2 = 0; i2 < 5; i2++) {
                txSumForSet += getTxValueWithIdx(i2);
                rxSumForSet += getRxValueWithIdx(i2);
            }
            ...
            for (int i3 = 0; i3 < 2; i3++) {
                txSumForUnset += getTxValueWithIdx(i3);
                rxSumForUnset += getRxValueWithIdx(i3);
            }
    ...
    private void updateAvgForLDR(int curState) {
        ...
        if (curState == 0) {
            ...
            for (int i3 = 0; i3 < 25; i3++) {
                txSumForSet2 += getTxValueWithIdx(i3);
