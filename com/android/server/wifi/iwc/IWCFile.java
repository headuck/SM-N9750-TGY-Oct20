...
public class IWCFile {
    ...
    public void writeDataAppend(String data) {
        ...
        try {
            ...
            Files.write(Paths.get(this.mFilePath, new String[0]), byteArray, StandardOpenOption.APPEND);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void writeData(String data) {
        checkDirectoryAndCreateFile();
        try {
            BufferedWriter writer = Files.newBufferedWriter(Paths.get(this.mFilePath, new String[0]), Charset.forName("UTF-8"), StandardOpenOption.WRITE, StandardOpenOption.TRUNCATE_EXISTING);
            writer.write(data);
            writer.close();
        } catch (IOException e) {
            e.printStackTrace();
