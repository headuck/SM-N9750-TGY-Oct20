...
public class ProxyBasedScanner implements WiFiScanner {
    ...
    private static final Map<Integer, Integer> mapFreqToCh = new HashMap();
    private CapInfo capInfo = null;
    private boolean isScanStarted;
    private List<Integer> lastScanChList = null;
    private Context mContext = null;
    private WiFiScanResultListener mListener = null;
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        /* class com.android.server.wifi.iwc.p000le.ProxyBasedScanner.C05171 */
            ...
            if (ProxyBasedScanner.this.isScanStarted && ProxyBasedScanner.this.mListener != null && intent.getAction().equals("android.net.wifi.SCAN_RESULTS")) {
                ...
                if (scannedChList.size() > 5) {
                    scannedChList.sort(new Comparator(mapChAPNum) {
                        /* class com.android.server.wifi.iwc.p000le.$$Lambda$ProxyBasedScanner$1$S0TbhhYf__Qty7RPLp8pxcNutE */
                ...
                ProxyBasedScanner.this.lastScanChList = null;
                ProxyBasedScanner.this.isScanStarted = false;
            }
        }
    ...
    @Override // com.android.server.wifi.iwc.p000le.WiFiScanner
