...
public class ActiveModeWarden {
    ...
    private boolean mSoftApDriverHangReset = false;
    ...
    public void enterSoftAPMode(SoftApModeConfiguration wifiConfig) {
        this.mHandler.post(new Runnable(wifiConfig) {
            /* class com.android.server.wifi.lambda */
    ...
    private void resetClientScanWithSoftAp() {
    ...
    public class ModeStateMachine extends StateMachine {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private void registerMonitorHandler() {
        ...
        private boolean checkForAndHandleModeChange(Message message) {
            ...
            if (i == 0) {
                ...
                if (ActiveModeWarden.this.mSoftApState == 13 || ActiveModeWarden.this.mSoftApState == 12) {
                    ...
                    ActiveModeWarden.this.mSoftApDriverHangReset = true;
                }
                    ...
                    switch (i) {
                        ...
                        case ActiveModeWarden.CMD_CLIENT_MODE_FAILED /*{ENCODED_INT: 131376}*/:
                            if (this.mListener == message.obj) {
                                ...
                                SemWifiIssueDetector semWifiIssueDetector = ActiveModeWarden.this.mIssueDetector;
                                int i2 = this.failCount;
                                this.failCount = i2 + 1;
                                semWifiIssueDetector.captureBugReport(7, ReportUtil.getReportDataForSupplicantStartFail(i2));
                                ActiveModeWarden.this.mModeStateMachine.transitionTo(ModeStateMachine.this.mWifiDisabledState);
                                break;
                            } else {
                                Log.d(ActiveModeWarden.TAG, "Client mode state change from previous manager");
        ...
        public void onStateChanged(int state, int reason) {
            if (state == 11) {
                ...
                if (ActiveModeWarden.this.mSoftApDriverHangReset) {
                    ActiveModeWarden.this.mSoftApDriverHangReset = false;
            ...
            ActiveModeWarden.this.mSoftApState = state;
        ...
        public void onStatusChanged(boolean isReady) {
            if (!isReady) {
                ActiveModeWarden.this.mHandler.post(new Runnable() {
                    /* class com.android.server.wifi.RunnableC0324xec250dc */
