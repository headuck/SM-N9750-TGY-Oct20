...
public class WifiController extends StateMachine {
    ...
    private static final String CSC_CONFIG_OP_BRANDING = SemCscFeature.getInstance().getString(CscFeatureTagWifi.TAG_CSCFEATURE_WIFI_CONFIGOPBRANDINGFORMOBILEAP, "ALL");
    ...
    public void start() {
        ...
        this.mContext.registerReceiver(new BroadcastReceiver() {
            /* class com.android.server.wifi.WifiController.C04481 */
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.net.wifi.STATE_CHANGE")) {
                    ...
                    if (wifistate == 1 && WifiController.this.mWifiInjector.getSemWifiApChipInfo().supportWifiSharing() && WifiController.this.mSoftApWifiConfig != null && WifiController.this.mDeferredSoftApEnable) {
                        ...
                        WifiController.this.mDeferredSoftApEnable = false;
    ...
    private void registerForWifiSharingModeChange() {
        this.mFacade.registerContentObserver(this.mContext, Settings.Secure.getUriFor("wifi_ap_wifi_sharing"), true, new ContentObserver(new Handler()) {
            /* class com.android.server.wifi.WifiController.C04492 */
            ...
            public void onChange(boolean selfChange) {
                ...
                wifiController.mIsWifiSharingModeEnabled = z;
    ...
    public String smToString(int what) {
        ...
        switch (what) {
            case CMD_WIFI_TOGGLED /*{ENCODED_INT: 155656}*/:
                return "CMD_WIFI_TOGGLED";
            case CMD_AIRPLANE_TOGGLED /*{ENCODED_INT: 155657}*/:
                return "CMD_AIRPLANE_TOGGLED";
            case CMD_SET_AP /*{ENCODED_INT: 155658}*/:
                return "CMD_SET_AP";
            default:
    ...
    private class P2pDisableCallback implements P2pDisableListener {
        ...
        @Override // com.android.server.wifi.WifiController.P2pDisableListener
    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 155654:
                case 155660:
                case WifiController.CMD_SET_AP_BOOSTER_FLAG /*{ENCODED_INT: 155671}*/:
                default:
                ...
                case WifiController.CMD_DEFERRED_RECOVERY_RESTART_WIFI /*{ENCODED_INT: 155672}*/:
                    break;
                case WifiController.CMD_AIRPLANE_TOGGLED /*{ENCODED_INT: 155657}*/:
                    ...
                    if (!WifiController.this.mSettingsStore.isAirplaneModeOn()) {
                        ...
                        if (!"VZW".equals(WifiController.CSC_CONFIG_OP_BRANDING) || WifiController.this.mSettingsStore.getPersistedWifiApState() != 1) {
                            ...
                            wifiController4.mSoftApWifiConfig = new SoftApModeConfiguration(1, wifiController4.mWifiInjector.getWifiApConfigStore().getApConfiguration());
                            if (WifiController.this.mSoftApWifiConfig != null) {
                                WifiController.this.mActiveModeWarden.enterSoftAPMode(WifiController.this.mSoftApWifiConfig);
                            } else {
                        ...
                        if (WifiController.this.mWifiInjector.getSemWifiApChipInfo().supportWifiSharing() && msg.arg1 == 1 && (mWifiApState == 11 || mWifiApState == 14)) {
                            ...
                            if (WifiController.this.mIsWifiSharingModeEnabled) {
                                if (WifiController.this.isP2pEnabled()) {
                                    ...
                                    WifiController.this.mSoftApWifiConfig = (SoftApModeConfiguration) msg.obj;
                                ...
                                WifiController.this.mSoftApWifiConfig = (SoftApModeConfiguration) msg.obj;
                                WifiController.this.mDeferredSoftApEnable = true;
                                break;
                            }
                        }
                ...
                case WifiController.CMD_AP_STOPPED /*{ENCODED_INT: 155663}*/:
                    ...
                    if (!WifiController.this.mResetSoftAp) {
                        ...
                        WifiController.this.mResetSoftAp = false;
                        if (WifiController.this.mSoftApWifiConfig != null) {
                            WifiController.this.mActiveModeWarden.enterSoftAPMode(WifiController.this.mSoftApWifiConfig);
                            break;
                        }
                ...
                case WifiController.CMD_AIRPLANE_TOGGLED /*{ENCODED_INT: 155657}*/:
                    ...
                    if ("VZW".equals(WifiController.CSC_CONFIG_OP_BRANDING)) {
                        if (!WifiController.this.mWifiInjector.getSemWifiApChipInfo().supportWifiSharing() || !WifiController.this.mIsWifiSharingModeEnabled) {
                            ...
                            if (!WifiController.this.isUsbTethered()) {
                                WifiController wifiController3 = WifiController.this;
                                wifiController3.mSoftApWifiConfig = new SoftApModeConfiguration(1, wifiController3.mWifiInjector.getWifiApConfigStore().getApConfiguration());
                                if (WifiController.this.mSoftApWifiConfig != null) {
                                    WifiController.this.mActiveModeWarden.enterSoftAPMode(WifiController.this.mSoftApWifiConfig);
                                } else {
                                    Log.e(WifiController.TAG, "mSoftApWifiConfig null");
                ...
                case WifiController.CMD_RECOVERY_RESTART_WIFI /*{ENCODED_INT: 155665}*/:
                    ...
                    if (msg.arg1 != 0) {
                        new Handler(WifiController.this.mClientModeImplLooper).post(new Runnable(bugTitle, bugDetail) {
                            /* class com.android.server.wifi.RunnableC0339x63e61ff3 */
