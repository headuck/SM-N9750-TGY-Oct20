...
public class WifiEleGeoMagnetic {
    ...
    private SensorEventListener mSensorListener = new SensorEventListener() {
        /* class com.android.server.wifi.WifiEleGeoMagnetic.C04521 */
    ...
    public interface OnEleDetectInterface {
        void onEleDetect();
    ...
    private boolean EleDetectNotifier() {
            ...
            while (!Thread.currentThread().isInterrupted()) {
                try {
                    WifiEleGeoMagnetic.this.handler.post(new Runnable() {
                        /* class com.android.server.wifi.WifiEleGeoMagnetic.SensorThread.RunnableC04531 */
