...
public class Matrix {
    ...
    public Matrix inverse(Matrix result, Matrix scratch) {
        int i = this.f42n;
        int i2 = this.f41m;
        if (i == i2 && i == result.f42n && i2 == result.f41m && i == scratch.f42n && i2 * 2 == scratch.f41m) {
            int i3 = 0;
            while (i3 < this.f42n) {
                int j = 0;
                while (j < this.f41m) {
                    scratch.put(i3, j, get(i3, j));
                    scratch.put(i3, this.f41m + j, i3 == j ? 1.0d : 0.0d);
                    j++;
                }
                i3++;
            }
            ...
            while (true) {
                ...
                if (i4 < ibest) {
                    ...
                    if (ibest2 != i4) {
                        for (int j2 = 0; j2 < scratch.f41m; j2++) {
                    ...
                    for (int i5 = ibest - 1; i5 >= 0; i5--) {
                        for (int ii3 = 0; ii3 < i5; ii3++) {
                            ...
                            for (int j5 = 0; j5 < scratch.f41m; j5++) {
                                scratch.put(ii3, j5, scratch.get(ii3, j5) - (scratch.get(i5, j5) * d3));
                            }
                        }
                    }
                    for (int i6 = 0; i6 < result.f42n; i6++) {
                        for (int j6 = 0; j6 < result.f41m; j6++) {
                            result.put(i6, j6, scratch.get(i6, this.f41m + j6));
                        }
                    }
                    return result;
                }
