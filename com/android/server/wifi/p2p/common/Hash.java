...
public class Hash {
    ...
    private static String longToString(long m) {
        ...
        for (int i = 7; i >= 0; i--) {
            sb.append(String.format("%02x", Byte.valueOf((byte) ((int) ((m >>> (i * 8)) & 255)))));
        }
    ...
    public static String retrieveDB(Context mContext, String numberhash, String crc) {
        ...
        try {
            ...
            Cursor c2 = contentResolver.query(uri, strArr, "mimetype='vnd.android.cursor.item/phone_v2' AND data12 LIKE '" + numberhash + "%'", null, null);
            if (c2 != null) {
                while (c2.moveToNext()) {
                    String data = c2.getString(c2.getColumnIndex("data1"));
