...
public class WifiConnectivityNotificationManager {
    ...
    public void showWifiPoorConnectionNotification(String ssid, int netId, boolean visible) {
        ...
        String message = this.mContext.getResources().getString(17042692, ssid);
        ...
        PendingIntent pendingContentIntent = PendingIntent.getActivityAsUser(this.mContext, 0, goAdvancedSettings, 134217728, null, UserHandle.CURRENT);
