...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(final Gson context, final Field field, String name, final TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        ...
        return new BoundField(name, serialize, deserialize) {
            /* class com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.C06331 */
            ...
            while (i < length) {
                ...
                if (serialize || deserialize) {
                    ...
                    while (i2 < fieldNames.size()) {
                        ...
                        previous = previous == null ? result.put(name, createBoundField(context, field, name, TypeToken.get(fieldType), serialize2, deserialize)) : previous;
                        i2++;
